...
public partial class TasksController
{
    ...
    {
        public const int ListTasks = 10001;
    ...
    [LoggerMessage(
        EventId = EventIds.ListTasks,
        EventName = nameof(EventIds.ListTasks),
        Level = LogLevel.Information,
        Message = "Get tasks. {Model}")]
    public partial void LogListTasks(ListTasksModel model);
